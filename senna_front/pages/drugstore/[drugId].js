...
// const response = await fetch("http://backend:8080/api/drugs").catch(err => console.log(err))
// console.log("deleteeeeeeee3", response)
// const router = useRouter
//    .catch(err => console.log(err))
// .then(console.log("get", await response))
...
function Drug({ drug }) {
   ...
   return (
      <><Header /><section className="text-gray-600 body-font overflow-hidden">
            ...
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
               ...
               <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                  ...
                  <div className="flex">
                     ...
                     <button type="button" className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded" onClick={deleteDrug}>Delete</button>
